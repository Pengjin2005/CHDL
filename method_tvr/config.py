...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--dset_name", type=str, choices=["tvr", "activitynet", "charades", "didemo"], default="tvr",)
        ...
        self.parser.add_argument("--lw_rec", type=float, default=1.0, help="weight for Decorrelation Loss")
        self.parser.add_argument("--lw_q", type=float, default=1e-2, help="weight for Quantization Loss")
        self.parser.add_argument("--lw_b", type=float, default=1e-3, help="weight for Balance Loss")
