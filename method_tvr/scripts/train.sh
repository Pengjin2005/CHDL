...
case ${dset_name} in
    tvr)
        train_path=data/TVR/tvr_train_release.jsonl
        video_duration_idx_path=data/TVR/tvr_video2dur_idx.json
        ...
        extra_args+=(data/TVR/tvr_val_release.jsonl)
        clip_length=1.5
